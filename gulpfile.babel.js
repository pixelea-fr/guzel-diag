...
const url = 'http://pixstarter.local/';
const paths = {
  styles: {
...
export const dev = series(clean, parallel(styles, images, svg, scripts, copy, copyVendor), start, watchForChanges)
export const nowatch = series(clean, parallel(styles, images, svg, scripts, copy, copyVendor))
export const build = series(clean, parallel(styles, images, svg, scripts, copy, copyVendor))
export default dev;